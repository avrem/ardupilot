...
const AP_Scheduler::Task Plane::scheduler_tasks[] = {
    ...
    SCHED_TASK_CLASS(AP_Generator, &plane.g2.generator, update, 50, 100),
    ...
    SCHED_TASK(update_follow_target,   50,    100),
#if MOUNT == ENABLED
...
void Plane::update_alt()
{
    ...
    if (auto_throttle_mode && !throttle_suppressed && !quadplane.in_vtol_mode()) {        
...
void Plane::update_flight_stage(void)
{
    ...
    if (control_mode == &mode_auto && !throttle_suppressed) {        
