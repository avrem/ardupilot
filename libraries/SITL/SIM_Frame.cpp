...
static const Motor tiltquad_motors[] = {
    Motor(AP_MOTORS_MOT_1,   45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  1, -1, 0, 0, 8, -90, 0),
    Motor(AP_MOTORS_MOT_2, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 3, -1, 0, 0, 9, 180, 90, true),
    Motor(AP_MOTORS_MOT_3,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 4, -1, 0, 0, 10, 0, -90),
    Motor(AP_MOTORS_MOT_4,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  2, -1, 0, 0, 11, 90, 180, true)
};
...
static Frame supported_frames[] =
{
    ...
    Frame("tilt-quad", 4, tiltquad_motors)
};
